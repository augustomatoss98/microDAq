...
### Field Description
- STX &emsp; &emsp; Start byte (0x02)
- LEN	&emsp; &emsp; Payload length
- SEQ	&emsp; &emsp; Sequence number
- CMD	&emsp; &emsp; Command identifier
- PAYLOAD &emsp; Data
- CRC	&emsp; &emsp; CRC-8 checksum
- ETX	&emsp; &emsp; End byte (0x03)
